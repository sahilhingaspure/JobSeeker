...
import com.mycompany.jobseeker.Admin;
import com.mycompany.jobseeker.AdminDAO;



@WebServlet(name = "AdminListController", urlPatterns = {"/AdminListController"})
public class AdminListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Forward the request to AdminView.jsp for displaying the data
